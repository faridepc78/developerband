<footer class="main-footer text-center" dir="ltr">
    <strong>کلیه حقوق برای<a href="{{route('home')}}"> دولوپربند </a>محفوظ می باشد @</strong>
</footer>
</div>
...
<script type="text/javascript" src="{{asset('assets/backend/plugins/sweetalert/js/sweetalert2@10.js')}}"></script>

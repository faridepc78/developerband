            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a class="my-active" href="{{route('projects.categories.create')}}">ایجاد
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">ایجاد دسته بندی های پروژه ها</h3>
                        </div>

                        <form id="store_category_form" action="{{route('projects.categories.store')}}"
                              method="post">

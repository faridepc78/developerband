...
<head>
    ...
    <title>ورود | DeveloperBand | طراحی و برنامه نویسی سایت و اپلیکیشن | دولوپربند</title>
...
<div class="login-box">
    <div class="login-logo">
        <a style="font-size: 20px" href="{{route('login')}}"><b>ورود به پنل مدیریت دولوپربند</b></a>
    </div>
    ...
    <div class="card">
        <div class="card-body login-card-body">
            ...
            <form id="login_form" action="{{route('send-login')}}" method="post">
                ...
                <div class="input-group mb-3">
                    ...
                    <input required onkeyup="this.value=removeSpaces(this.value)" id="user_name" type="text"
